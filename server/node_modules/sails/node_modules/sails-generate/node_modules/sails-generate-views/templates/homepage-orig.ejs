...
<div class="container clearfix">
    <div class="main">
            ...
            <ul class="getting-started">
                <li>
                    ...
                    <div>
                        ...
                        <p>
                            Run <span class="boxy">sails generate api user</span>.  This will create two files: a model <span class="boxy">api/models/User.js</span> and a controller <span class="boxy">api/controllers/UserController.js</span>
                        </p>
                    </div>
                </li>
                <li>
                    ...
                    <div>
                        ...
                        <p>
                            Run <span class="boxy">sails lift</span> to start up your app server.  If you visit <a href="http://localhost:1331/user"><span class="boxy">http://localhost:1331/user</span></a> in your browser, you'll see a socket.io-compatible REST API was generated for your 'User' model.
                        </p>
                    </div>
                </li>
                <li>
                    ...
                    <div>
                        ...
                        <p>From here, you might modify your `User` model, set up policies, configure CORS, and/or define your own explicit routes (see this project's <span class="boxy">config/routes.js</span> file.)  To override all or part of the built-in API with custom logic, just write your own controller <a href="http://links.sailsjs.org/docs/controllers">actions</a> and they'll override the defaults.  Sails syntax follows well-established Node conventions-- in fact, Sails actions are <a href="http://links.sailsjs.org/guide/migrating-an-express-app">compatible with existing Express code</a>, with the added bonus of supporting <a href="http://links.sailsjs.org/docs/interpreter">both HTTP and WebSockets</a> out of the box.</p>

                        <p>Visit <a href="http://sailsjs.org">the Sails website</a> for more info and tips on getting started.</p>
        ...
        //
        // If we know the relative path to the current
        // view, display it.
        //
        ...
        <div class="delete">
            <div class="sprite">
                You're looking at <span class="boxy"><%= view.pathFromApp %>.<%= view.ext %></span>
            </div>
        </div><%
    	} %>
    </div>
    <div class="side-bar">
        ...
        <ul>
            <li>
                <a target="_blank" href="http://sailsjs.org">Visit sailsjs.org</a>
            </li>
            <li>
                <a target="_blank"  href="http://links.sailsjs.org/docs">Read the docs</a>
            </li>
            <li>
                <a target="_blank" href="http://links.sailsjs.org/docs/faq">Frequently asked questions</a>
            </li>
            <li>
                <a target="_blank" href="http://stackoverflow.com">Ask a question on StackOverflow</a>
            </li>
        </ul>
        <h4>
            Next Steps
        ...
        <ul>
            <li class="sprite api">
                <a target="_blank" href="http://links.sailsjs.org/docs/guide/build-an-api">Build an API</a>
            </li>
            <li class="sprite single_page">
                <a target="_blank" href="http://links.sailsjs.org/docs/guide/build-a-single-page-app">Build a single page app</a>
            </li>
            <li class="sprite traditional">
                <a target="_blank" href="http://links.sailsjs.org/docs/guide/build-a-traditional-webapp">Build a traditional web app</a>
            </li>
            <li class="sprite realtime">
                <a target="_blank" href="http://links.sailsjs.org/docs/guide/build-a-realtime-app">Build a chat application</a>
            </li>
        </ul>
    </div>
</div>
