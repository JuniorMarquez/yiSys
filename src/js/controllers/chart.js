...
var numero = $scope.especialistas.length;
 $scope.total= numero;
 for (var i = 0;i<$scope.especialistas.length;i++){
    ...
    $http.get('http://localhost:1331/categoria/?idEstablecimiento='+MyService.data.idEstablecimiento).then(function (resp2) {
...
//       // $http.get('http://localhost:1331/ordeno/?idEstablecimiento='+MyService.data.idEstablecimiento).then(function (resp) {
