...
$scope.calculoExistenciaespecialistas2=function(item){
...
$scope.calculoExistenciaespecialistas2(MyService.data.identificador);
...
$http.get('http://localhost:1331/porcentajeganancia/?idEstablecimiento='+MyService.data.idEstablecimiento).then(function (resp2) {
    $scope.porcentajes = resp2.data.results;  
});
$http.get('http://localhost:1331/unidadingrediente/?idEstablecimiento='+MyService.data.idEstablecimiento).then(function (resp2) {
    $scope.unidades = resp2.data.results;  
});



$http.get('http://localhost:1331/departamento/?idEstablecimiento='+MyService.data.idEstablecimiento).then(function (resp2) {
    var bandera="";
    var bandera2="";
...
// $http.get('http://localhost:1331/alimento/?idUsuario='+MyService.data.idUsuario).then(function (resp2) {
//     var bandera="";
//     var bandera2="";
...
// });
// $http.get('http://localhost:1331/tipoDepartamento/?idUsuario='+MyService.data.idUsuario).then(function (resp2) {
//     var bandera="";
//     var bandera2="";
...
// });
// $http.get('http://localhost:1331/tipoAlimento/?idUsuario='+MyService.data.idUsuario).then(function (resp2) {
//     var bandera="";
//     var bandera2="";
...
// });
// $http.get('http://localhost:1331/tipoMedicamento/?idUsuario='+MyService.data.idUsuario).then(function (resp2) {
//     var bandera="";
//     var bandera2="";
...
$http.get('http://localhost:1331/sucursal/?idEstablecimiento='+MyService.data.idEstablecimiento).then(function (resp2) {
    var bandera="";
    var bandera2="";
...
$scope.borrar=function(item){
   var idRaza=item.id;
      $http.delete('http://localhost:1331/raza/'+idRaza , item)
      $modalInstance.dismiss('cancel');
};
$scope.borrarAlimento=function(item){
   var idAlimento=item.id;
      $http.delete('http://localhost:1331/alimento/'+idAlimento , item)
      $modalInstance.dismiss('cancel');
};
$scope.borrarSucursal=function(item){
   var idSucursal=item.id;
      $http.delete('http://localhost:1331/sucursal/'+idSucursal , item)
      $modalInstance.dismiss('cancel');
};
$scope.borrarDepartamento=function(item){
   var idDepartamento=item.id;
      $http.delete('http://localhost:1331/departamento/'+idDepartamento , item)
      $modalInstance.dismiss('cancel');
};
$scope.borrarTipoDepartamento=function(item){
   var idTipoDepartamento=item.id;
      $http.delete('http://localhost:1331/tipoDepartamento/'+idTipoDepartamento , item)
      $modalInstance.dismiss('cancel');
};
$scope.borrarTipoAlimento=function(item){
   var idTipoAlimento=item.id;
      $http.delete('http://localhost:1331/tipoAlimento/'+idTipoAlimento , item)
      $modalInstance.dismiss('cancel');
};
$scope.borrarTipoMedicamento=function(item){
   var idTipoMedicamento=item.id;
      $http.delete('http://localhost:1331/tipoMedicamento/'+idTipoMedicamento , item)
      $modalInstance.dismiss('cancel');
};
//  $scope.filterOptions = {
//         filterText: "",
...
//     }, true);
    ...
    //  $http.get('http://localhost:1331/raza/?idUsuario='+MyService.data.idUsuario).then(function (resp) {
    ...
    $scope.okSalto = function (item) {
      ...
      $http.post('http://localhost:1331/salto/' ,item);  
      $modalInstance.close();
      // var pas = item._id;
...
$scope.calculoExistenciaespecialistas=function(idingrediente){
  ...
  $scope.alerts=null;
    ...
    $http.get('http://localhost:1331/entrada/?idArticulo='+idArticulo).then(function (resp) {
      $scope.entradas=resp.data.results;
      for (var i=0;i<$scope.entradas.length;i++){
        entradas=entradas+$scope.entradas[i].cantidad;
        }
        $http.get('http://localhost:1331/salida/?idArticulo='+idArticulo).then(function (resp) {
    ...
    $scope.okEntrada = function (item) {
      ...
      $http.post('http://localhost:1331/entrada/' ,item);  
      $modalInstance.close();
 ...
 $scope.okEntradaingrediente = function (item) {
      ...
      item.idUsuario=MyService.data.idUsuario;
       ...
       item.idEstablecimiento=MyService.data.idEstablecimiento;
      $http.post('http://localhost:1331/entradaingrediente/' ,item);  
      $modalInstance.close();
      $scope.calculoExistenciaespecialistas(idingrediente);
      // var pas = item._id;
      // $scope.ordenosFiltrados = $scope.ordenos.filter(function (ordeno) {
 ...
 //    };
      ...
      item.idArticulo=idArticulo;
      item.idUsuario=MyService.data.idUsuario;
      $http.post('http://localhost:1331/peso/' ,item);  
 ...
 //    };
      ...
      item.idArticulo=idArticulo;
      item.idUsuario=MyService.data.idUsuario;
      $http.post('http://localhost:1331/parto/' ,item);  
     $scope.nuevoArticulo={};
     $scope.nuevoArticulo.barcode=item.barcode;
      $scope.nuevoArticulo.nombre=item.nombre;
       ...
       $http.post('http://localhost:1331/articulo/' ,$scope.nuevoArticulo);
      $modalInstance.close();
      // var pas = item._id;
      // $scope.ordenosFiltrados = $scope.ordenos.filter(function (ordeno) {
      //   return (ordeno.idArticulo == pas );
    ...
    $scope.okSalida = function (item) {
      ...
      $http.post('http://localhost:1331/salida/' ,item);  
      $modalInstance.close();
      $scope.calculoExistenciaespecialistas(idArticulo);
      // var pas = item._id;
      // $scope.ordenosFiltrados = $scope.ordenos.filter(function (ordeno) {
      //   return (ordeno.idArticulo == pas );
      // });
     ...
     $scope.okSalidaingrediente = function (item) {
      ...
      $http.post('http://localhost:1331/salidaingrediente/' ,item);  
      $modalInstance.close();
      $scope.calculoExistenciaespecialistas(idingrediente);
      // var pas = item._id;
      // $scope.ordenosFiltrados = $scope.ordenos.filter(function (ordeno) {
    ...
    $scope.cargaMachos = function(){
      $http.get('http://localhost:1331/articulo/?idUsuario='+MyService.data.idUsuario).then(function (resp) {
  ...
  $scope.cargaMachos();
    ...
    //   $http.get('http://localhost:1331/tipoDepartamento/?idUsuario='+MyService.data.idUsuario).then(function (resp) {
    //     $scope.tiposDepartamentos = resp.data.results;
    //   });
    // };
    // $scope.cargaTiposMedicamentos = function(){
    //   $http.get('http://localhost:1331/tipoMedicamento/?idUsuario='+MyService.data.idUsuario).then(function (resp) {
    //     $scope.tiposMedicamentos = resp.data.results;
    //   });
    // };
    $scope.cargaDepartamentos = function(){
      $http.get('http://localhost:1331/departamento/?idUsuario='+MyService.data.idUsuario).then(function (resp) {
        $scope.Departamentos = resp.data.results;
      });
    };
    //  $scope.cargaTiposAlimentos = function(){
    //   $http.get('http://localhost:1331/tipoAlimento/?idUsuario='+MyService.data.idUsuario).then(function (resp) {
    //     $scope.tiposAlimentos = resp.data.results;
    //   });
    // };
    // $scope.cargaAlimentos = function(){
    //   $http.get('http://localhost:1331/alimento/?idUsuario='+MyService.data.idUsuario).then(function (resp) {
    //     $scope.alimentos = resp.data.results;
    //   });
    // };
    // $scope.cargaMedicamentos = function(){
    //   $http.get('http://localhost:1331/medicamento/?idUsuario='+MyService.data.idUsuario).then(function (resp) {
...
$scope.okSucursal = function (item) {
    ...
    // };
      ...
      // item.idArticulo=idArticulo;
       item.idUsuario=MyService.data.idUsuario;
       item.idEstablecimiento=MyService.data.idEstablecimiento;
      $http.post('http://localhost:1331/sucursal/' ,item);       
      $modalInstance.close();
    //   var pas = item._id;
    ...
    // };
      ...
      // item.idArticulo=idArticulo;
       item.idUsuario=MyService.data.idUsuario;
      $http.post('http://localhost:1331/alimento/' ,item);       
      $modalInstance.close();
    //   var pas = item._id;
    //   $scope.departamentosFiltrados = $scope.departamentos.filter(function (departamento) {  
    //   return (departamento.idArticulo == pas );
    // });
     ...
     $scope.okRaza = function (item) {
       ...
       item.idUsuario=MyService.data.idUsuario;
      $http.post('http://localhost:1331/raza/' ,item);       
      $modalInstance.close();
     ...
     $scope.okTipoMedicamento = function (item) {
       item.idUsuario=MyService.data.idUsuario;
      $http.post('http://localhost:1331/tipomedicamento/' ,item);       
      $modalInstance.close();
      };
       ...
       item.idUsuario=MyService.data.idUsuario;
      $http.post('http://localhost:1331/tipoalimento/' ,item);       
      $modalInstance.close();
      };

       $scope.okTipoDepartamento = function (item) {
       item.idUsuario=MyService.data.idUsuario;
      $http.post('http://localhost:1331/tipodepartamento/' ,item);       
      $modalInstance.close();
      };
    $scope.okDepartamento = function (item) {
      item.idUsuario=MyService.data.idUsuario;
      item.idEstablecimiento=MyService.data.idEstablecimiento;
      $http.post('http://localhost:1331/departamento/' ,item);       
      $modalInstance.close();
    ...
    // };
      var idArticulo=MyService.data.identificador;
       item.idArticulo=idArticulo;
       item.idUsuario=MyService.data.idUsuario;
      $http.post('http://localhost:1331/sumAlimento/' ,item);       
      $modalInstance.close();
    //   var pas = item._id;
    //   $scope.departamentosFiltrados = $scope.departamentos.filter(function (departamento) {  
    //   return (departamento.idArticulo == pas );
    ...
    // };
      var idArticulo=MyService.data.identificador;
       item.idArticulo=idArticulo;
       item.idUsuario=MyService.data.idUsuario;
      $http.post('http://localhost:1331/sumMedicamento/' ,item);       
      $modalInstance.close();
    //   var pas = item._id;
    //   $scope.departamentosFiltrados = $scope.departamentos.filter(function (departamento) {  
    //   return (departamento.idArticulo == pas );
 ...
 $scope.okSumDepartamento = function (item) {
    ...
    // };
      var idArticulo=MyService.data.identificador;
       item.idArticulo=idArticulo;
       item.idUsuario=MyService.data.idUsuario;
      $http.post('http://localhost:1331/sumDepartamento/' ,item);       
      $modalInstance.close();
    //   var pas = item._id;
    //   $scope.departamentosFiltrados = $scope.departamentos.filter(function (departamento) {  
    //   return (departamento.idArticulo == pas );
...
// ##########################################################################
    $scope.okConfirm = function (item) { 
      var idArticulo=MyService.data.identificador;
      $http.delete('http://localhost:1331/articulo/'+idArticulo , item)
    ...
    $scope.okConfirmingrediente = function (item) { 
      var idingrediente=MyService.data.identificador;
      $http.delete('http://localhost:1331/ingrediente/'+idingrediente , item)
      // $scope.items.splice($scope.items.indexOf(item), 1);
      $scope.items = null;
      $scope.item = null;
    ...
    $http.delete('http://localhost:1331/categoria/'+idCategoria, item)
