...
.state('apps.inventario', {
                  url: '/inventario',
                  templateUrl: 'tpl/apps_inventario.html',
                   resolve: {
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                          return $ocLazyLoad.load(['ui.select','toaster']).then(
                              function(){
                                return $ocLazyLoad.load( ['js/app/inventario/inventario.js',
                                  'js/controllers/chart.js',
                                'js/controllers/bootstrap.js'
                                                  ]);
                              }
...
.state('apps.especialistas', {
                  url: '/especialistas',
                  templateUrl: 'tpl/apps_especialistas.html',
                   resolve: {
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                          return $ocLazyLoad.load(['ui.select','toaster']).then(
                              function(){
                                return $ocLazyLoad.load( ['js/app/especialistas/especialistas.js',
                                  'js/controllers/chart.js',
                                'js/controllers/bootstrap.js'
                                                  ]);
                              }
...
.state('apps.historicoArticulo', {
                  url: '/historicoArticulo',
                  templateUrl: 'tpl/apps_historicoArticulo.html',
                   resolve: {
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                          return $ocLazyLoad.load(['ui.select','ngGrid']).then(
                              function(){
                                  return $ocLazyLoad.load('js/app/articulo/historicoArticulo.js');
                              }
                          );
                      }]
                  }
...
.state('apps.historicoArticuloMacho', {
                  url: '/historicoArticuloMacho',
                  templateUrl: 'tpl/apps_historicoArticuloMacho.html',
                   resolve: {
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                          return $ocLazyLoad.load(['ui.select','ngGrid']).then(
                              function(){
                                  return $ocLazyLoad.load('js/app/articulo/historicoArticuloMacho.js');
                              }
                          );
                      }]
                  }
