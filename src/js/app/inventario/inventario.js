...
MyService.data.luz=null; 
    ...
    $http.get('http://localhost:1331/articulo/?idEstablecimiento='+MyService.data.idEstablecimiento).then(function (resp) {
...
$scope.openPeso = function (item) {
  ...
  $scope.selectItem = function(item){    
    ...
    //  $http.get('http://localhost:1331/peso/?idArticulo='+identificador).then(function (resp) {
  ...
  $scope.deleteItem = function(item){
    $http.delete('http://localhost:1331/articulo/'+item.id , item)
  ...
  $scope.deleteArticulo = function(articulo){
    $http.delete('http://localhost:1331/articulo/'+articulo.id , articulo)
  ...
  articuloAct.estado=item.estado;
   articuloAct.control=false;
    ...
    if (MyService.data.idenArticulo){
      $scope.pop4();
      $http.put('http://localhost:1331/articulo/'+MyService.data.idenArticulo , articuloAct)
    }
    else {
      $scope.pop3();;
      $http.post('http://localhost:1331/articulo/', articuloAct)
    }
    $http.get('http://localhost:1331/categoria/?idEstablecimiento='+MyService.data.idEstablecimiento).then(function (resp) {
      $scope.categorias = resp.data.results;
    });
