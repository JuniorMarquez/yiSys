...
app.controller('historicoArticuloMachoCtrl', ['$scope', '$http', '$filter', '$modal', 'MyService', 'filterFilter', 'datepickerConfig',function($scope, $http, $filter,$modal, MyService,filterFilter, datepickerConfig) {
  ...
  $scope.tbOptions6 = {
    ...
    $scope.getPesos = function () {
      $scope.pesos=null;
      $http.get('http://localhost:1331/peso/?idArticulo='+MyService.data.articuloConsultado.id).then(function (resp) {
...
$scope.getPesos();
    $scope.getEntradas = function () {
      ...
      $http.get('http://localhost:1331/tratamiento/?idArticulo='+MyService.data.articuloConsultado.id).then(function (resp) {
    ...
    $scope.getDepartamentos = function () {
      ...
      $http.get('http://localhost:1331/sumdepartamento/?idArticulo='+MyService.data.articuloConsultado.id).then(function (resp) {
    ...
    $scope.getMedicamentos = function () {
      ...
      $http.get('http://localhost:1331/summedicamento/?idArticulo='+MyService.data.articuloConsultado.id).then(function (resp) {
...
$scope.getAlimentos = function () {
      ...
      $http.get('http://localhost:1331/sumalimento/?idArticulo='+MyService.data.articuloConsultado.id).then(function (resp) {
...
$scope.getAlimentos();
    ...
    $scope.getSaltos = function () {
      $scope.saltos=null;
      $http.get('http://localhost:1331/salto/?macho.id='+MyService.data.articuloConsultado.id).then(function (resp) {
