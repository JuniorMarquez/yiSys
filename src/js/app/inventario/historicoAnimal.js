...
app.controller('historicoArticuloCtrl', ['$scope', '$http', '$filter', '$modal', 'MyService', 'filterFilter', 'datepickerConfig',function($scope, $http, $filter,$modal, MyService,filterFilter, datepickerConfig) {
    $scope.getGrafico =function(){
      ...
      $http.get('http://localhost:1331/ordeno/?idArticulo='+MyService.data.articuloConsultado.id).then(function (resp) {
...
$scope.getPesos = function () {
    ...
    $scope.getSaltos = function () {
      $scope.saltos=null;
      $http.get('http://localhost:1331/salto/?idArticulo='+MyService.data.articuloConsultado.id).then(function (resp) {
    ...
    $scope.getPromedio =function(){
      ...
      $http.get('http://localhost:1331/ordeno').then(function (resp) {
